...
スコアの基準
10：完全に一致。表現にほぼ差がない。症状・疾患内容が完全に対応している
9：わずかな表現の違いはあるが、意味としては完全に一致するとみなせる
7〜8：非常に近い概念であり、通常のコーディングでは十分に妥当とされる
4〜6：関連はあるが、文脈や補足情報がないと曖昧になりうる
1〜3：ごくわずかに関連するが、通常は他のPTの方がより適切である
